...
public interface ICartRepository
{
    ...
    Task<CartDetail> AddCustomProductToCartAsync(int cartId, int customProductId);
    Task<CartDetail> GetCartDetailByCartAndProductAsync(int cartId, int productId, int? customProductId = null);
}