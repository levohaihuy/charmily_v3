...
public class CartRepository : ICartRepository
{
    ...
    {
        return await _cartDAO.AddCustomProductToCartAsync(cartId, customProductId);
    }

    // Update existing method
    public async Task<CartDetail> GetCartDetailByCartAndProductAsync(int cartId, int productId, int? customProductId = null)
    {
        return await _cartDAO.GetCartDetailByCartAndProductAsync(cartId, productId, customProductId);
    }
}